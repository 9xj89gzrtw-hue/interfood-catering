...
const VENUES: Venue[] = [
  {
    ...
    features: ["Шатёр на территории форта", "Сцена для артистов", "30 км от СПБ", "Приплыть на корабле"],
    description: "На территории форта установлен шатёр. Вместимость при банкетной рассадке до 150 персон. Имеется сцена для артистов. Есть возможность приплыть к форту прямо на корабле.",
  },
  {
    id: 2,
    name: "Грузино-4, Лосевода, Павловский парк",
    ...
    beforeImage: IMG.venue1,
    afterImage: IMG.venue1,
    features: ["Парковая зона", "Отель Ретур", "Остров", "Шатры"],
    description: "Загородные площадки для банкета: Грузино-4, Лосевода, Павловский парк, отель Ретур, остров. Роскошные загородные усадьбы и парковые зоны с панорамными видами.",
  },
  {
    id: 3,
    name: "Теплоход «Чайка»",
    type: "Двухпалубный теплоход",
    category: "На воде",
    capacity: "до 70 гостей",
    price: "от 8 000 ₽/час аренды",
    image: IMG.venue3,
    beforeImage: IMG.venue3,
    afterImage: IMG.venue3,
    features: ["Двухпалубный", "Вид на Неву", "Веранда", "Открытая палуба"],
    description: "Двухпалубный теплоход «Чайка» до 70 человек. Аренда от 8 000 ₽/час (апрель, октябрь) до 10 500 ₽/час (июнь). Банкеты на теплоходе — незабываемая атмосфера.",
  },
  {
    id: 4,
    name: "Юсуповский дворец на Мойке",
    type: "Дворец и особняк",
    category: "Городские",
    ...
    features: ["Памятник 18 века", "Исторический интерьер", "Зеркальный зал", "Парадная лестница"],
    description: "Уникальный архитектурный ансамбль начала 18 века, памятник истории и культуры федерального значения. Величественные залы для самых изысканных мероприятий.",
  },
  {
    id: 5,
    name: "Корсаков, Ниагара",
    type: "Банкетные залы",
    category: "Городские",
    capacity: "30–250 гостей",
    price: "от 4 470 ₽/чел",
    image: IMG.venue5,
    beforeImage: IMG.venue5,
    afterImage: IMG.venue5,
    features: ["Ресторанный зал", "Фуршетная зона", "Сцена", "Парковка"],
    description: "Банкетные залы и дворцы: Юсуповский дворец, Корсаков, Ниагара, Белосельских-Белозерских. Подберём площадку под любой формат и бюджет.",
  },
  {
    id: 6,
    name: "Теплоходы «Альта», «Генерал», «Марсель», «Соммерс»",
    ...
    description: "Банкеты на теплоходе — уникальная атмосфера на воде. Доступны теплоходы «Альта», «Генерал», «Марсель», «Соммерс» различной вместимости. Незабываемый вид на Неву и мосты.",
  },
];
...
export default function VenuesPage() {
  ...
  return (
    <main style={{ background: "var(--color-warm-white)", overflow: "hidden" }}>
      ...
      {/* ═══ WhatsApp Float ═══ */}
      <a
        href="https://wa.me/79119417205?text=%D0%97%D0%B4%D1%80%D0%B0%D0%B2%D1%81%D1%82%D0%B2%D1%83%D0%B9%D1%82%D0%B5!%20%D0%A5%D0%BE%D1%87%D1%83%20%D0%B7%D0%B0%D0%B1%D1%80%D0%BE%D0%BD%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D1%82%D1%8C%20%D0%BF%D0%BB%D0%BE%D1%89%D0%B0%D0%B4%D0%BA%D1%83"
        target="_blank"
