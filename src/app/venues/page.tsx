...
const VENUES: Venue[] = [
  ...
  },
  {
    ...
    afterImage: IMG.banquet,
    features: ["Арт-пространство", "Минимализм", "Гибкая планировка", "Свет"],
    description: "Современное арт-пространство с минималистичным дизайном. Гибкая планировка для любых форматов — от фуршетов до конференций.",
  },
];
            ...
            {VENUES.slice(0, 3).map((venue, i) => (
              <Reveal key={venue.id} delay={i * 0.15}>
                <div>
                  ...
                  <p style={{ fontSize: "0.8rem", color: "#888" }}>{venue.type} · {venue.capacity}</p>
                </div>
              </Reveal>
            ))}
          </div>
