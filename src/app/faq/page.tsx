    ...
    questions: [
      {
        ...
        a: "Оставьте заявку на сайте, позвоните по телефону +7 (812) 919-59-11 или напишите нам на interfood-catering@yandex.ru. Менеджер свяжется с вами в течение 30 минут для уточнения деталей: формат мероприятия, количество гостей, пожелания по меню и дату.",
      },
      {
        q: "За сколько времени нужно бронировать кейтеринг?",
        a: "Минимальный заказ — за 48 часов до мероприятия. Мы рекомендуем бронировать за 7–14 дней. Для крупных событий (от 100 гостей) желательно обратиться за 3–4 недели. В высокий сезон (май–сентябрь, декабрь) бронь лучше делать за месяц.",
      },
      {
      ...
      },
      {
        ...
        a: "Минимальный заказ — от 15 человек для фуршета и от 20 человек для банкета. Для кофе-брейка минимальный заказ — от 10 человек.",
      },
      {
    ...
    questions: [
      {
        ...
        a: "Мы предлагаем четыре основных формата: фуршет (от 2 450 ₽/гость, канапе, брускетты, закуски), банкет (от 4 470 ₽/гость, полноценный ужин с обслуживанием), кофе-брейк (от 950 ₽/гость, напитки и выпечка для конференций) и барбекю. Каждый формат адаптируется под ваше мероприятие.",
      },
      {
        q: "Можно ли составить индивидуальное меню?",
        a: "Безусловно! Шеф-повар Дмитрий Нилов разработает меню специально для вашего мероприятия с учётом концепции, бюджета и предпочтений гостей. Мы предлагаем дегустацию перед заказом — вы сможете оценить блюда и внести коррективы.",
      },
      {
      ...
      },
      {
        ...
        a: "Да, для заказов от 30 человек мы проводим бесплатную дегустацию на нашей кухне. Вы сможете попробовать ключевые позиции из вашего меню. Дегустация согласовывается за 5–7 дней до мероприятия.",
      },
      {
    ...
    questions: [
      {
        ...
        a: "Да, мы обслуживаем мероприятия в Санкт-Петербурге и Ленинградской области. Доставка в пределах города включена в стоимость меню. Доставка за пределы города рассчитывается индивидуально.",
      },
      {
        q: "Входит ли доставка в стоимость?",
        a: "Да, доставка в пределах Санкт-Петербурга включена в стоимость меню. Доставка за пределы города рассчитывается индивидуально в зависимости от расстояния.",
      },
      {
        q: "Что входит в услугу обслуживания персоналом?",
        a: "В стандартный пакет входит: официанты (1 на 10–15 гостей), повар-сушист, бармен, менеджер мероприятия. Персонал прибывает за 2 часа до начала, проводит сервировку и остаётся до окончания + 1 час на уборку.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Отмена за 7+ дней — полный возврат предоплаты. Отмена за 3–7 дней — возврат 70%. Отмена менее чем за 3 дня — возврат 30%. Перенос мероприятия на другую дату — без штрафов при уведомлении за 5+ дней.",
      },
      {
        q: "Есть ли скрытые платежи или доплаты?",
        a: "Нет, мы работаем прозрачно. В договоре фиксируется полная стоимость: меню, персонал, оборудование, доставка в пределах города. Дополнительные расходы возможны только при ваших запросах, не предусмотренных изначальным заказом — все они согласовываются заранее.",
      },
      {
        q: "Что будет, если еды не хватит на всех гостей?",
        a: "Мы всегда закладываем запас порций +10% от согласованного количества. Если гостей стало больше — до +5 человек, мы обеспечим питание без доплат. За 18 лет работы ни один гость не остался без угощения.",
      },
    ],
  },
];
