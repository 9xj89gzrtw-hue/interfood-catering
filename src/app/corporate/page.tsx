...
const FORMATS = [
  {
    title: "В офисе",
    subtitle: "Выездной фуршет или банкет",
    desc: "Мы организуем выездное обслуживание прямо у вас в офисе. Привезём необходимую посуду, текстиль, блюда и закуски. Сервируем столы согласно нормам ресторанного этикета. Ваш офис на время превратится в шикарный ресторан.",
    img: IMG.conference,
    features: ["Полное обслуживание", "Посуда и текстиль", "Фуршет или банкет", "Доставка в пределах КАД"],
  },
  {
    title: "В банкетном зале",
    subtitle: "Дворцы и атриумы",
    desc: "Подберём для вас оригинальную площадку, атриум или дворец. Вы отметите корпоратив в интерьере дворцового Петербурга, что положительно отразится на настроении ваших сотрудников.",
    img: IMG.buffet,
    features: ["Юсуповский дворец", "Корсаков", "Ниагара", "Белосельских-Белозерских"],
  },
  {
    title: "На природе",
    subtitle: "BBQ / активный отдых",
    desc: "Если ваши сотрудники любят активный отдых, предложим провести корпоратив на скалодроме или на крытом футбольном поле, где мы профессионально организуем выездной фуршет или кофе-брейк.",
    img: IMG.teambuilding,
    features: ["BBQ и гриль", "Выездной фуршет", "Кофе-брейк", "Шатёр с обогревом"],
  },
  {
    title: "Новогодний",
    subtitle: "от 1 970 ₽/чел",
    desc: "Организация новогодних корпоративных выездных банкетов, фуршетов и кофе-брейков. Стоимость на персону — 1 970 ₽. В стоимость входит доставка, обслуживание официантами, посуда, текстиль, уборка мусора.",
    img: IMG.presentation,
    features: ["Дуэт форели и палтуса", "Ростбиф из австралийской говядины", "Салат Цезарь", "Горячее на выбор"],
  },
];
...
const CASES = [
  {
    client: "Новогодний корпоратив",
    title: "Выездной банкет — 1 970 ₽/чел",
    guests: 50,
    duration: "Полный сервис",
    result: "Всё включено",
    desc: "Дуэт форели и копчёного палтуса, в окружении королевских креветок. Мясное блюдо из трёх видов деликатесов. Салат Цезарь с айсбергом и пармезаном. Горячее на выбор: медальоны из свиной вырезки, куриная грудка с горчичным соусом или стейк из форели.",
    quote: "В стоимость входит доставка, обслуживание официантами, посуда, текстиль, уборка мусора после мероприятия.",
    quoteAuthor: "Команда Interfood Catering",
    img: IMG.conference,
  },
  {
    client: "Pepsico",
    title: "Кофе-брейк на 300 персон",
    guests: 300,
    duration: "Полный день",
    result: "Кофе-брейк",
    desc: "Фуршетный формат с интерактивными станциями для продуктовой презентации. Клаб-сэндвичи, круассаны, мини-пирожные и ассортимент печенья. Зерновой кофе и пакетированный чай. Обслуживание официантами и полная сервировка.",
    quote: "Стильно, вкусно, профессионально.",
    quoteAuthor: "Представитель Pepsico",
    img: IMG.dessert,
  },
  {
    client: "Aurora Concert Hall",
    title: "Корпоратив на 250 персон",
    guests: 250,
    duration: "Выездной банкет",
    result: "20 официантов, 5 шеф-поваров",
    desc: "Выездной банкет для масштабного корпоративного мероприятия. 20 официантов и 5 шеф-поваров. Рыбные композиции, салаты, мясные и сырные нарезки. Горячее приготовлено на мангале. Полная координация таймлайна с ведущим и музыкантами.",
    quote: "Профессионализм команды — в каждом моменте нашей работы.",
    quoteAuthor: "Дмитрий Нилов, основатель",
    img: IMG.teambuilding,
  },
];
