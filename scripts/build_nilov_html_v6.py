...
# -*- coding: utf-8 -*-
"""
Build /home/z/my-project/download/catering_inspiration_nilov.html (v6.0)

Client-reading simulation fixes over v5.0:
- REMOVED apologetic premium tone («выше среднерыночного, но не премиум»)
- REMOVED academic source citations («Источник: Forbes / CXL / HBR / Emerald»)
- REMOVED «Премиум-вариант на 50 чел — 111 875 ₽» from 100K section
- REMOVED «по данным CaterMe и Catery» research-y citation from 100K note
- FIXED Card 03 Great Performances: 1979 → 1980 (verified via homepage)
- FIXED Card 03: removed unverifiable «~1200 сотрудников» + 4 exclusive venue claims
- FIXED Card 13 Pinch Food Design: removed unverifiable «TJ Girard» name (only Bob Spiegel confirmed on About page)
- FIXED Card 09 Daniel et Daniel: removed unverifiable «ICA Best Hors D'œuvre 2024» award
- FIXED Card 16 Moving Venue: removed unverifiable «двойной лауреат 2025» + «£7m оборот» claims
- FIXED Card 17 Dish Dubai: removed unverifiable «Nick Alvis» + «мишленовский опыт» claims
- FIXED Card 19 Amici: removed unverifiable «Brands For Good 2019» award
- FIXED Card 11 Catering by Michaels: removed unverifiable «$300/$125/4.9/138 отзывов» specific numbers
- FIXED Card 08 By Word of Mouth: removed unverifiable «B Corp» claim
- FIXED Card 15 Potel et Chabot: removed unverifiable «Accor group» + «Banquet des Maires 1900» specific claims
- ENRICHED Card 10 Ridgewells: added verified «16 presidential inaugurations» (from official About page)
- SIMPLIFIED poll: replaced 57 checkboxes with simple text instruction
- REDUCED aggregators from 8 to 5 (removed Bash Today, vc.ru, rating.spb.ru — redundant with CaterMe/Спб)
- WARMER design: lighter hero (less dark green), more terra accent
- Softened Stat 5 «медиана +37%, до +400%» → «главное — доверие клиента»
"""
...
.poll-list li strong{color:var(--accent);font-weight:600;}
.poll-extra{
  font-size:15px;
  line-height:1.7;
  color:rgba(245,237,224,0.78);
...
.poll-note strong{color:var(--accent);font-weight:600;}
...
@media (max-width:900px){
  ...
  .poll-compact{padding:8px 22px 26px;}
}
@media (max-width:560px){
  ...
  .poll-compact{padding:6px 18px 22px;}
  .format-example{font-size:15px;padding:14px 16px;}
}
...
PROOF_100K = [
    {
        ...
        "detail": "Стандартный фуршет с обслуживанием. Хороший вариант для корпоратива или юбилея.",
    ...
    },
    {
        ...
        "detail": "Готовые сеты в коробках — самый быстрорастущий формат. Доставка + забор посуды.",
...
PRINCIPLES = [
    {
        ...
        "impact": "↑ первое впечатление — за 0,05 сек"
    },
    {
        "num": "02 · Фуд-фотография",
        "title": "Студийный свет — главный носитель качества",
        "body": "Не «скачано со стока» и не «снято на телефон при жёлтом свете». Студийный свет, фуд-стайлинг, макро-крупные планы, контрастный фон. Фотография еды важнее текста — именно она продаёт.",
        "impact": "↑ до +30% к продажам блюд"
    },
    {
        "num": "03 · Палитра",
        "title": "Два цвета + один акцент — не больше",
        "body": "Хороший вкус — это всегда ограничение. Базовый (тёмно-зелёный, кремовый, графитовый) + 1 акцент (тёплое золото, терракота, олива). Никогда — все цвета радуги. Палитра должна быть читаема на скриншоте 200×200 px. Пёстрая палитра создаёт ощущение дешевины.",
        "impact": "↑ +впечатление ценности"
    },
    {
        "num": "04 · Типографика",
        "title": "Шрифты с засечками = «солидно», без засечек = «современно»",
        "body": "Cormorant Garamond, Playfair Display — это шрифты с засечками, типографика журналов и книг. Шрифты без засечек (Inter, Montserrat) говорят «современно», но менее «солидно». Связка Cormorant + Inter — почти универсальна для кейтеринга.",
        "impact": "↑ +впечатление ценности бренда"
    },
    {
        "num": "05 · Сигналы доверия",
        "title": "Логотипы клиентов и цифры — рядом с кнопкой заявки",
        "body": "«5000 мероприятий», «15 лет на рынке», логотипы известных клиентов, награды, отзывы — всё, что снимает возражение «кто эти люди?». Без сигналов доверия форма заявки работает заметно хуже. Размещайте их не в подвале, а рядом с кнопкой.",
        "impact": "↑ главное — доверие клиента"
    },
    {
...
WORLD_CATERERS = [
    ...
    },
    {
        ...
        "about": "Семейная история с 1975 года — 50 лет на рынке. Свадебный и корпоративный кейтеринг в Нью-Йорке.",
    ...
    },
    {
        ...
        "about": "Основан в 1980 году Лиз Ноймарк — изначально как агентство официанток. Сегодня — один из ведущих кейтерингов Нью-Йорка, обслуживает корпоративные и культурные события.",
    ...
    },
    {
        ...
        "about": "Более 40 лет опыта. Сдержанный британский стиль, журнальная фотография.",
        "style": "Сдержанный британский стиль, журнальная фотография.",
        "up": "40+ лет опыта → знак стабильности и доверия",
    ...
    },
    {
        ...
        "about": "Один из самых титулованных кейтерингов Канады, на рынке с 1980 года — 45 лет. Свадебные и корпоративные мероприятия, фирменный магазин в Cabbagetown.",
        "style": "Тёплая палитра, награды на видном месте, журнальная подача.",
        "up": "Награды на виду → мгновенный знак доверия для требовательных клиентов",
    ...
    },
    {
        ...
        "about": "Семейный бизнес с 1928 года — 95+ лет. Обслужил более 16 президентских инаугураций, бесчисленное множество государственных приёмов в Вашингтоне.",
        "style": "Классический, тёплый, с акцентом на историю семьи.",
        "up": "«16 инаугураций» + 95 лет → мощнейший знак доверия и стабильности",
    ...
    },
    {
        ...
        "about": "Семейный бизнес с 1980 года — 45 лет. Один из немногих американских кейтерингов, кто публикует цены прямо на сайте.",
        "style": "Тёплый, семейный, с прозрачными ценами.",
        "up": "Прозрачные цены → снимает главное возражение «дорого?»",
    ...
    },
    {
        ...
        "about": "Основан шеф-поваром Бобом Шпигелем. Команда шефов и дизайнеров создаёт собственную мебель для еды — кастомные станции и сервировку.",
        "style": "Авторский, концептуальный, с акцентом на дизайн станций.",
        "up": "Уникальный подход «еда + дизайн-мебель» → виральность, выделение на фоне конкурентов",
    ...
    },
    {
        ...
        "about": "Один из старейших кейтерингов Франции — основан в 1820 году, более 200 лет истории. Обслуживает самые престижные государственные и корпоративные приёмы Франции.",
    ...
    },
    {
        ...
        "about": "Более 40 лет на рынке. Один из ведущих кейтерингов Лондона, аккредитованный на самых известных площадках города.",
        "style": "Светлая палитра, акцент на награде в первом экране.",
        "up": "40+ лет и лидерство на рынке Лондона → надёжность и доверие",
    ...
    },
    {
        ...
        "url": "dish.ae",
        "href": "https://dish.ae",
        "about": "Авторский кейтеринг в Дубае и Абу-Даби. Корпоративы, gala-ужины, частные события. Лауреат индустриальных премий 2024 года.",
        "style": "Тёмный фон, тёплый золотой акцент. Арабская эстетика.",
        "up": "Премии 2024 → актуальное признание индустрии",
    ...
    },
    {
        ...
        "about": "Семейный бутик-кейтеринг с 2002 года — 23 года. Любые масштабы: от домашних вечеринок до больших событий. Сезонные меню.",
        "style": "Тёплая, дружелюбная эстетика. Акцент на сезонности.",
        "up": "Семейная история 23 года → доверие для частных клиентов",
        "down": "Мало конкретных цен — для среднего чека нужен калькулятор",
...
# ============================================================
# POLL — simplified to a single text instruction (no more 57-checkbox grid)
# ============================================================
...
<section class="proof100k">
  <div class="container">
    ...
    <h2 class="section-title">Бюджет <em>100 000 &#8381;</em> — это много или мало?</h2>
    <p class="section-sub">Это полноценный бюджет для хорошего праздника. Ниже — четыре реальных варианта, которые можно собрать на эту сумму прямо сейчас в Санкт-Петербурге. Цены — с сайтов указанных кейтерингов.</p>
    <div class="proof-grid">{cards_html}
    </div>
    <div class="proof-note">
      <strong>Что это значит для сайта:</strong> на 100 000 &#8381; клиент может заказать фуршет на 40–60 чел, банкет на 25–35 чел или кофе-брейк на 100–125 чел. Сайт должен давать эти ориентиры сразу — таблица «от X &#8381;/чел» или простой калькулятор снимает главное возражение «дорого?» и экономит время клиента.
    </div>
  </div>
</section>
"""
...
<section class="hero" id="top">
  <div class="container hero-inner">
    ...
    <p class="hero-lead">Перед вами <strong>40 живых сайтов</strong> кейтерингов из 9 стран мира и лучшие компании Москвы и Санкт-Петербурга. Откройте те, что зацепили взглядом, задержитесь на каждом 1–2 минуты — и пришлите мне 3–5 номеров понравившихся. На этом основании мы зафиксируем стиль вашего будущего сайта.</p>
  ...
  <div class="container">
    ...
    <div class="howto-steps">
      ...
      <div class="howto-step">
        ...
        <p>Отметьте 3–5 понравившихся + 1–2 «что точно НЕ нравится». Пришлите мне номера в Telegram — текстом или скриншотом. <strong>Минимум — 3 номера + 2–3 слова о предпочтениях.</strong> Дальше — моя работа.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="poll">
  <div class="container">
    <span class="section-eyebrow" style="color:var(--accent);">5 минут — и готово</span>
    <h2>Что вам <em>понравилось</em>?</h2>
    <p class="lead">Откройте 5–7 сайтов из подборки выше. Отметьте 3–5 понравившихся и пришлите мне их номера в Telegram.</p>

    <div class="poll-compact">
      <h3 class="poll-block-title">Пример сообщения</h3>
      <div class="format-example">
        «Понравились: 1, 6, 15, M2, S3. Не понравились: 4, S5. Хочу тёплую палитру, фото блюд крупным планом, цены на сайте».
      </div>

      <h3 class="poll-block-title">Что обязательно указать</h3>
      <ul class="poll-list">
        <li><strong>3–5 номеров</strong> понравившихся кейтерингов (из любой группы — мировые, Москва, СПб)</li>
        <li><strong>1–2 номера</strong>, что точно НЕ понравилось</li>
        <li><strong>2–3 слова</strong> о предпочтениях: палитра (светлая/тёмная), подача (имиджевая/каталог), акцент (фото/текст/истории)</li>
      </ul>

      <h3 class="poll-block-title">Если хочется подробнее</h3>
      <p class="poll-extra">Пришлите 2–3 скриншота конкретных сайтов, где понравилась определённая секция (главная, меню, галерея) — и подпись, что именно нравится. Это самый полезный формат — я смогу точно перенести удачные элементы.</p>
    </div>

    <div class="poll-note">
      <strong>Минимум:</strong> 3 номера + 2–3 слова о предпочтениях. Дальше — моя работа.
    </div>
  </div>
</section>
"""
