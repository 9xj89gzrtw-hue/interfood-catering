#!/usr/bin/env python3
"""
Компиляция промпта v2.1 для Lovable под кейтеринг Nilov Catering (СПб).
Версия: v2.1 (Lovable Edition, 24 июня 2026)
Исправления: 4 критичных + 5 средних ошибок.
Новые идеи: тренды UX 2026, AI-search оптимизация, Vercel Edge для Telegram.
"""
from pathlib import Path

OUTPUT = Path("/home/z/my-project/download/lovable_prompt_nilov_catering_v2_1.md")
OUTPUT.parent.mkdir(parents=True, exist_ok=True)

PROMPT = r"""# ПРОМПТ ДЛЯ LOVABLE — САЙТ NILOV CATERING (СПб) · v2.1
